    ...
    <footer>
      ...
      >
        ...
        <div className="text-sm text-gray-600">
          &copy; KPMG Audit AI - Tous droits réservés.
        </div>
        </div>
